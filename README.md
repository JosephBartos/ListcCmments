...
Added to two new components Comments.js and TopComments.js
Added theme.js using material-ui primary and secondary colors
Updated view.js adding getTopCommenters and getCommentsList
